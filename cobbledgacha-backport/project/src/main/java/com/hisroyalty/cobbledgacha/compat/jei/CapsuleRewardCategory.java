...
public class CapsuleRewardCategory implements IRecipeCategory<CapsuleRewardRecipe> {
    public static final RecipeType<CapsuleRewardRecipe> TYPE = RecipeType.create(CobbledGacha.MOD_ID, "capsule_rewards", CapsuleRewardRecipe.class);
    ...
    public CapsuleRewardCategory(IGuiHelper gui) {
        ...
        icon = gui.createDrawableIngredient(mezz.jei.api.constants.VanillaTypes.ITEM_STACK,
            new ItemStack(CobbledGacha.CAPSULES.get(0).get()));
    }

    @Override public RecipeType<CapsuleRewardRecipe> getRecipeType() { return TYPE; }
    @Override public Component getTitle() { return Component.translatable("jei.cobbledgacha.capsule_rewards"); }
    @Override public IDrawable getBackground() { return background; }
    @Override public IDrawable getIcon() { return icon; }

    @Override public void setRecipe(IRecipeLayoutBuilder builder, CapsuleRewardRecipe recipe, IFocusGroup focuses) {
    ...
    @Override public void draw(CapsuleRewardRecipe recipe, IRecipeSlotsView slots, GuiGraphics graphics, double mouseX, double mouseY) {
